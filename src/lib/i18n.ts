export const dict = {
  ...
  // New UI Labels
  tagline: 'Independent Political & Tech Feed',
  organization: 'Pulefeed',
  footerTagline: 'Independent news you can trust. Modern reporting delivered with integrity and energy.',
